...
public class ValidationModule implements Extension {
    ...
    public void install(@Nonnull Jooby application) throws Exception {
        ...
        application.decoder(MediaType.json, validatedJacksonDecoder(jacksonModule, application.getServices().require(Validator.class)));
    }
    ...
    static MessageDecoder validatedJacksonDecoder(JacksonModule jacksonModule, Validator validator) {
        return new MessageDecoder() {
            ...
            private static <T> ValidationErrorResponseDto convertConstrainViolation(Set<ConstraintViolation<T>> violations) {
